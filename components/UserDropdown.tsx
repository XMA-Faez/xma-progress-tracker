      ...
      {isOpen && (
        <div className="absolute glass-card right-0 top-full mt-2 w-full rounded-lg shadow-xl border overflow-hidden">
          <div className="p-2">
            <Link 
              href="/admin/profile" 
              className="w-full flex items-center gap-3 px-3 py-2 rounded-md text-slate-300 hover:bg-slate-700 hover:text-white transition-colors"
            ...
            <form action="/api/auth/signout" method="post">
              <button className="w-full flex items-center gap-3 px-3 py-2 rounded-md text-slate-300 hover:bg-slate-700  hover:text-white transition-colors">
